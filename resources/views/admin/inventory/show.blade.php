...
@section('page_title') <i class="fa fa-th mr10"></i>#{{$item->serial_no}} @endSection
...
<ol class="breadcrumb float-right nav_breadcrumb_top_align" style="margin-bottom: 0">
	...
	<li class="breadcrumb-item h-padding-5"><a href="{{route('admin.inv')}}">Tasks</a></li>
			...
			<div class="col-sm-6">
				...
				<div class="card">
					...
					<div class="card-header bgc-070">
						<h4 class="font-600 text-center no-padding no-margin text-uppercase c-fff">Task - Actions</h4>
					</div>
